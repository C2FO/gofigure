    ...
    describe('with mixins', () => {
      it('should load a file and merge in mixins', () => {
        const loader = new FileLoader({
          file: path.resolve(__dirname, '../__fixtures__/config-mixin/config-mixin.production-one.json'),
        });
        const expectedConfig = _.merge({}, helper.configMixinProductionOne, {
          __mixin__: helper.productionMixin.mixin,
        });
  ...
  describe('#watch', () => {
    it('watch a file for changes sync', () => {
      ...
      return new Promise((res, rej) => {
        loader.watch().on(
          'change',
          helper.rejectIfError(rej, (name, conf) => {
    ...
    it('watch for changes in mixins sync', () => {
      ...
      const expectedLoadedConfig = _.merge({}, helper.configMixinProductionOne, {
        __mixin__: helper.productionMixin.mixin,
      });
